...
defmodule OrbitalDynamics.CampaignPlanner.RepairCandidateDiffAmbiguousMatchTest do
  ...
  test "repair preserves ambiguous candidate-diff replacement matches" do
    ...
    candidate_diff_report = %{
      ...
      "new_candidates" => [
        %{
          ...
          "semantic_match_candidate_ids" => ["dl_old", "dl_old"]
        },
        %{
          "id" => "dl_high_score",
          "type" => "downlink",
      ...
      "invalidated_candidates" => [
        ...
        %{
          ...
          "candidate_budget_match_count" => 1,
          "budget_dropped_candidate_ids" => ["dl_semantic"],
          "semantic_change_reasons" => ["ends_at_s_changed"]
        }
      ]
    }
    ...
    assert %{
             ...
             "candidate_diff_match_status" => "ambiguous_source_candidate_diff",
             "candidate_diff_match_count" => 2,
             "invalidated_candidate_ids" => ["dl_old", "dl_old"],
             "candidate_budget_match_status" => "budget_dropped_replacement_candidate",
             "candidate_budget_match_count" => 1,
             "budget_dropped_candidate_ids" => ["dl_semantic"],
             "semantic_change_reasons" => ["ends_at_s_changed", "starts_at_s_changed"]
