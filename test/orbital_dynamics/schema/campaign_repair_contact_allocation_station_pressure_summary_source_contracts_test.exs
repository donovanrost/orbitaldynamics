defmodule OrbitalDynamics.Schema.CampaignRepairContactAllocationStationPressureSummarySourceContractsTest do
  use ExUnit.Case, async: true

  alias OrbitalDynamics.Schema

  @source_field "source_contact_allocation_station_pressure_summary"
  ...
  test "validates the optional V2 source station-pressure summary", %{artifact: artifact} do
  ...
  test "exports the source station-pressure-summary property" do
