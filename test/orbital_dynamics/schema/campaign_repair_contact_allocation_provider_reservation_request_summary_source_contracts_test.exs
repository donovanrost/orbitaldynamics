defmodule OrbitalDynamics.Schema.CampaignRepairContactAllocationProviderReservationRequestSummarySourceContractsTest do
  use ExUnit.Case, async: true

  alias OrbitalDynamics.Schema

  @source_field "source_contact_allocation_provider_reservation_request_summary"
  ...
  test "validates the optional V2 source provider-reservation request summary", %{
    artifact: artifact
  } do
  ...
  test "exports the source provider-reservation request-summary property" do
