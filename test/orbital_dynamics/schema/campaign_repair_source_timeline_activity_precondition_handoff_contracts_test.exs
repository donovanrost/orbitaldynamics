...
defmodule OrbitalDynamics.Schema.CampaignRepairSourceTimelineActivityPreconditionHandoffContractsTest do
  ...
  test "rejects Repair source timeline activity-precondition handoff drift", %{
    ...
    stale_handoffs = Map.delete(repair, "source_timeline_activity_precondition_summaries")

    stale_indexed_handoffs =
      update_in(repair, ["source_timeline_activity_precondition_summaries"], &Enum.take(&1, 1))
