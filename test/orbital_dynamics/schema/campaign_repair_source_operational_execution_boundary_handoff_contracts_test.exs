defmodule OrbitalDynamics.Schema.CampaignRepairSourceOperationalExecutionBoundaryHandoffContractsTest do
  ...
  setup_all do
    ...
    repair =
      ...
      |> Map.put("source_operational_execution_boundary_summary", summary)
  ...
  test "replays the normalized execution-boundary summary projection", %{
    repair: repair,
  ...
  test "rejects source execution-boundary identity drift at every produced path", %{
    repair: repair
  } do
  ...
  test "rejects coordinated projection drift, missing rows, and stale handoffs", %{
    ...
    stale_handoffs = Map.delete(repair, "source_operational_execution_boundary_summary")
