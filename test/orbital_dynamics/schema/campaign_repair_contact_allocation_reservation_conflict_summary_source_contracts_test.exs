defmodule OrbitalDynamics.Schema.CampaignRepairContactAllocationReservationConflictSummarySourceContractsTest do
  ...
  test "validates the optional V2 source reservation-conflict summary", %{artifact: artifact} do
  ...
  test "exports the source reservation-conflict-summary property" do
