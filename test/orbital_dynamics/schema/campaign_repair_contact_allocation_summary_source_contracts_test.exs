defmodule OrbitalDynamics.Schema.CampaignRepairContactAllocationSummarySourceContractsTest do
  use ExUnit.Case, async: true

  alias OrbitalDynamics.Schema

  @source_field "source_contact_allocation_summary"
  ...
  test "validates the optional V2 source compact allocation summary", %{artifact: artifact} do
  ...
  test "exports the source compact allocation-summary property" do
