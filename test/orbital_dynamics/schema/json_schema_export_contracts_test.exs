defmodule OrbitalDynamics.Schema.JsonSchemaExportContractsTest do
  ...
  test "exports recommendation risk context" do
    ...
    aggregate_fields = [
      ...
      {"contact_filter_pressure_required_contact_values", "number", nil},
      {"contact_filter_pressure_planned_contact_values", "number", nil},
      {"contact_filter_pressure_required_downlink_values_mb", "number", nil},
      {"contact_filter_pressure_planned_downlink_values_mb", "number", nil},
      {"contact_filter_pressure_start_values_s", "number", nil},
      {"contact_filter_pressure_end_values_s", "number", nil},
      {"contact_filter_pressure_suppressed_reasons", "string", nil},
      {"contact_filter_pressure_review_statuses", "string", nil},
      {"contact_filter_pressure_station_reservation_ids", "string", stable_id_pattern},
      {"contact_filter_pressure_station_reserved_by", "string", nil},
      {"contact_filter_pressure_station_reservation_statuses", "string", nil},
      {"contact_filter_pressure_station_reservation_match_statuses", "string", nil},
      {"contact_filter_pressure_station_calendar_entry_ids", "string", stable_id_pattern},
      {"contact_filter_pressure_station_calendar_entry_statuses", "string", nil},
      {"contact_filter_pressure_downlink_demand_sources", "string", nil},
      {"contact_filter_pressure_downlink_completion_sources", "string", nil},
      {"contact_filter_pressure_feedback_sources", "string", nil},
      {"contact_filter_pressure_feedback_scopes", "string", nil},
      {"contact_filter_pressure_trust_boundaries", "string", nil},
      {"contact_filter_pressure_derivation_reasons", "string", nil},
      {"link_capacity_pressure_risk_types", "string", nil},
      {"link_capacity_pressure_ground_station_ids", "string", stable_id_pattern},
      {"link_capacity_pressure_required_contact_values", "number", nil},
      {"link_capacity_pressure_planned_contact_values", "number", nil},
      {"link_capacity_pressure_required_downlink_values_mb", "number", nil},
      {"link_capacity_pressure_planned_downlink_values_mb", "number", nil},
      {"link_capacity_pressure_start_values_s", "number", nil},
      {"link_capacity_pressure_end_values_s", "number", nil},
      {"link_capacity_pressure_source_activity_ids", "string", stable_id_pattern},
      {"link_capacity_pressure_source_window_ids", "string", stable_id_pattern},
      {"link_capacity_pressure_selected_capacity_adjusted_throughput_values_mb", "number", nil},
      {"link_capacity_pressure_selected_downlink_shortfall_values_mb", "number", nil},
      {"link_capacity_pressure_actual_throughput_values_mb", "number", nil},
      {"link_capacity_pressure_actual_downlink_completion_ratio_values", "number", nil},
      {"link_capacity_pressure_actual_downlink_shortfall_values_mb", "number", nil},
      {"link_capacity_pressure_downlink_requirement_statuses", "string", nil},
      {"link_capacity_pressure_actual_downlink_requirement_statuses", "string", nil},
      {"link_capacity_pressure_downlink_demand_sources", "string", nil},
      {"link_capacity_pressure_downlink_completion_sources", "string", nil},
      {"link_capacity_pressure_feedback_sources", "string", nil},
      {"link_capacity_pressure_feedback_scopes", "string", nil},
      {"link_capacity_pressure_trust_boundaries", "string", nil},
      {"link_capacity_pressure_derivation_reasons", "string", nil},
      {"score_term_pressure_risk_types", "string", nil},
      {"score_term_pressure_objective_ids", "string", stable_id_pattern},
      {"score_term_pressure_objective_types", "string", nil},
      {"score_term_pressure_latency_objective_values", "boolean", nil},
      {"score_term_pressure_target_ids", "string", stable_id_pattern},
      {"score_term_pressure_scenario_ids", "string", stable_id_pattern},
      {"score_term_pressure_branch_ids", "string", stable_id_pattern},
      {"score_term_pressure_ground_station_ids", "string", stable_id_pattern},
      {"score_term_pressure_collection_ids", "string", stable_id_pattern},
      {"score_term_pressure_product_ids", "string", stable_id_pattern},
      {"score_term_pressure_payload_ids", "string", stable_id_pattern},
      {"score_term_pressure_instrument_ids", "string", stable_id_pattern},
      {"score_term_pressure_start_values_s", "number", nil},
      {"score_term_pressure_end_values_s", "number", nil},
      {"score_term_pressure_required_contact_values", "number", nil},
      {"score_term_pressure_planned_contact_values", "number", nil},
      {"score_term_pressure_required_downlink_values_mb", "number", nil},
      {"score_term_pressure_planned_downlink_values_mb", "number", nil},
      {"score_term_pressure_max_latency_values_s", "number", nil},
      {"score_term_pressure_planned_latency_values_s", "number", nil},
      {"score_term_pressure_required_observation_values", "number", nil},
      {"score_term_pressure_planned_observation_values", "number", nil},
      {"score_term_pressure_priorities", "number", nil},
      {"score_term_pressure_latitude_values_deg", "number", nil},
      {"score_term_pressure_longitude_values_deg", "number", nil},
      {"score_term_pressure_minimum_elevation_values_deg", "number", nil},
      {"score_term_pressure_source_activity_ids", "string", stable_id_pattern},
      {"score_term_pressure_keys", "string", nil},
      {"score_term_pressure_values", "number", nil},
      {"score_term_pressure_timeline_score_values", "number", nil},
      {"score_term_pressure_score_term_maps", "object", nil},
      {"score_term_pressure_downlink_demand_sources", "string", nil},
      {"score_term_pressure_downlink_completion_sources", "string", nil},
      {"score_term_pressure_feedback_sources", "string", nil},
      {"score_term_pressure_feedback_scopes", "string", nil},
      {"score_term_pressure_trust_boundaries", "string", nil},
      {"score_term_pressure_derivation_reasons", "string", nil},
      {"objective_satisfaction_pressure_risk_types", "string", nil},
      {"objective_satisfaction_pressure_objective_ids", "string", stable_id_pattern},
      {"objective_satisfaction_pressure_objective_types", "string", nil},
      {"objective_satisfaction_pressure_objective_statuses", "string", nil},
      {"objective_satisfaction_pressure_source_objective_statuses", "string", nil},
      {"objective_satisfaction_pressure_latency_objective_values", "boolean", nil},
      {"objective_satisfaction_pressure_target_ids", "string", stable_id_pattern},
      {"objective_satisfaction_pressure_scenario_ids", "string", stable_id_pattern},
      {"objective_satisfaction_pressure_spacecraft_ids", "string", stable_id_pattern},
      {"objective_satisfaction_pressure_branch_ids", "string", stable_id_pattern},
      {"objective_satisfaction_pressure_ground_station_ids", "string", stable_id_pattern},
      {"objective_satisfaction_pressure_collection_ids", "string", stable_id_pattern},
      {"objective_satisfaction_pressure_product_ids", "string", stable_id_pattern},
      {"objective_satisfaction_pressure_payload_ids", "string", stable_id_pattern},
      {"objective_satisfaction_pressure_instrument_ids", "string", stable_id_pattern},
      {"objective_satisfaction_pressure_start_values_s", "number", nil},
      {"objective_satisfaction_pressure_end_values_s", "number", nil},
      {"objective_satisfaction_pressure_required_contact_values", "number", nil},
      {"objective_satisfaction_pressure_planned_contact_values", "number", nil},
      {"objective_satisfaction_pressure_required_downlink_values_mb", "number", nil},
      {"objective_satisfaction_pressure_planned_downlink_values_mb", "number", nil},
      {"objective_satisfaction_pressure_max_latency_values_s", "number", nil},
      {"objective_satisfaction_pressure_planned_latency_values_s", "number", nil},
      {"objective_satisfaction_pressure_required_observation_values", "number", nil},
      {"objective_satisfaction_pressure_planned_observation_values", "number", nil},
      {"objective_satisfaction_pressure_priorities", "number", nil},
      {"objective_satisfaction_pressure_latitude_values_deg", "number", nil},
      {"objective_satisfaction_pressure_longitude_values_deg", "number", nil},
      {"objective_satisfaction_pressure_minimum_elevation_values_deg", "number", nil},
      {"objective_satisfaction_pressure_observation_success_factor_values", "number", nil},
      {"objective_satisfaction_pressure_image_quality_score_values", "number", nil},
      {"objective_satisfaction_pressure_image_quality_statuses", "string", nil},
      {"objective_satisfaction_pressure_image_quality_sources", "string", nil},
      {"objective_satisfaction_pressure_cloud_cover_fraction_values", "number", nil},
      {"objective_satisfaction_pressure_blur_score_values", "number", nil},
      {"objective_satisfaction_pressure_quality_feedback_sources", "string", nil},
      {"objective_satisfaction_pressure_source_activity_ids", "string", stable_id_pattern},
      {"objective_satisfaction_pressure_missed_downlink_activity_ids", "string",
       stable_id_pattern},
      {"objective_satisfaction_pressure_realized_statuses", "string", nil},
      {"objective_satisfaction_pressure_contact_results", "string", nil},
      {"objective_satisfaction_pressure_candidate_window_maps", "object", nil},
      {"objective_satisfaction_pressure_allowed_scenario_ids", "string", stable_id_pattern},
      {"objective_satisfaction_pressure_spacecraft_constraint_maps", "string", stable_id_pattern},
      {"objective_satisfaction_pressure_coverage_objective_ids", "string", stable_id_pattern},
      {"objective_satisfaction_pressure_downlink_demand_sources", "string", nil},
      {"objective_satisfaction_pressure_downlink_completion_sources", "string", nil},
      {"objective_satisfaction_pressure_feedback_sources", "string", nil},
      {"objective_satisfaction_pressure_feedback_scopes", "string", nil},
      {"objective_satisfaction_pressure_trust_boundaries", "string", nil},
      {"objective_satisfaction_pressure_derivation_reasons", "string", nil},
      {"objective_tradeoff_pressure_risk_types", "string", nil},
      {"objective_tradeoff_pressure_objective_ids", "string", stable_id_pattern},
      {"objective_tradeoff_pressure_objective_types", "string", nil},
      {"objective_tradeoff_pressure_latency_objective_values", "boolean", nil},
      {"objective_tradeoff_pressure_target_ids", "string", stable_id_pattern},
      {"objective_tradeoff_pressure_scenario_ids", "string", stable_id_pattern},
      {"objective_tradeoff_pressure_branch_ids", "string", stable_id_pattern},
      {"objective_tradeoff_pressure_ground_station_ids", "string", stable_id_pattern},
      {"objective_tradeoff_pressure_collection_ids", "string", stable_id_pattern},
      {"objective_tradeoff_pressure_product_ids", "string", stable_id_pattern},
      {"objective_tradeoff_pressure_payload_ids", "string", stable_id_pattern},
      {"objective_tradeoff_pressure_instrument_ids", "string", stable_id_pattern},
      {"objective_tradeoff_pressure_start_values_s", "number", nil},
      {"objective_tradeoff_pressure_end_values_s", "number", nil},
      {"objective_tradeoff_pressure_required_contact_values", "number", nil},
      {"objective_tradeoff_pressure_planned_contact_values", "number", nil},
      {"objective_tradeoff_pressure_required_downlink_values_mb", "number", nil},
      {"objective_tradeoff_pressure_planned_downlink_values_mb", "number", nil},
      {"objective_tradeoff_pressure_max_latency_values_s", "number", nil},
      {"objective_tradeoff_pressure_planned_latency_values_s", "number", nil},
      {"objective_tradeoff_pressure_source_activity_ids", "string", stable_id_pattern},
      {"objective_tradeoff_pressure_score_values", "number", nil},
      {"objective_tradeoff_pressure_score_delta_from_selected_values", "number", nil},
      {"objective_tradeoff_pressure_score_term_maps", "object", nil},
      {"objective_tradeoff_pressure_required_observation_values", "number", nil},
      {"objective_tradeoff_pressure_planned_observation_values", "number", nil},
      {"objective_tradeoff_pressure_priorities", "number", nil},
      {"objective_tradeoff_pressure_latitude_values_deg", "number", nil},
      {"objective_tradeoff_pressure_longitude_values_deg", "number", nil},
      {"objective_tradeoff_pressure_minimum_elevation_values_deg", "number", nil},
      {"objective_tradeoff_pressure_feedback_sources", "string", nil},
      {"objective_tradeoff_pressure_feedback_scopes", "string", nil},
      {"objective_tradeoff_pressure_trust_boundaries", "string", nil},
      {"objective_tradeoff_pressure_derivation_reasons", "string", nil},
  ...
  test "exported schemas do not leave identity fields opaque or report counts as objects" do
    # This single export assertion deliberately replaces the duplicate assertion in the former
    # contract-wide count scan; both invariants inspect the same successful boundary export.
    exported_contracts =
      Schema.contracts()
      |> Enum.map(fn {contract_name, contract} ->
        assert {:ok, schema} = Schema.json_schema(contract_name)
        {contract_name, contract, schema}
      end)

    violations =
      Enum.flat_map(exported_contracts, fn {contract_name, _contract, schema} ->
        schema
    ...
    count_violations =
      Enum.flat_map(exported_contracts, fn {contract_name, contract, schema} ->
        fields =
