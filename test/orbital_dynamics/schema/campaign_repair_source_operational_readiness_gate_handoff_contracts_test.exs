defmodule OrbitalDynamics.Schema.CampaignRepairSourceOperationalReadinessGateHandoffContractsTest do
  ...
  setup_all do
    ...
    repair =
      ...
      |> Map.put("source_operational_readiness_gate_summary", summary)
  ...
  test "replays the normalized readiness-gate summary projection", %{
    repair: repair,
  ...
  test "rejects source readiness-gate identity drift at every produced path", %{
    repair: repair
  } do
  ...
  test "rejects coordinated projection drift, missing rows, and stale handoffs", %{
    ...
    stale_handoffs = Map.delete(repair, "source_operational_readiness_gate_summary")
