defmodule OrbitalDynamics.MissionPlan.ActivityTest do
  ...
  test "declares typed activity capabilities" do
    ...
    assert :station_availability in preserved_fields
    assert :station_calendar_entry_id in preserved_fields
    assert :station_calendar_provider_id in preserved_fields
    assert :station_calendar_provider_entry_id in preserved_fields
    assert :station_calendar_directions in preserved_fields
    ...
    assert :source_station_calendar_overlaps in preserved_fields
    assert :station_calendar_overlap_count in preserved_fields
    assert :station_calendar_overlap_entry_ids in preserved_fields
    assert :station_calendar_overlap_availabilities in preserved_fields
    assert :station_calendar_entry_ambiguous in preserved_fields
