defmodule OrbitalDynamics.CandidateRefresh.CommandManeuverFeedbackBuildTest do
  use ExUnit.Case, async: true

  alias OrbitalDynamics.{CandidateRefresh, Epoch, ResultSet, Schema}

  test "preserves command and maneuver success feedback in refresh provenance" do
    artifact =
      result_set()
      |> CandidateRefresh.build(
        candidate_refresh:
          ...
          |> put_in(["operational_feedback"], %{
            ...
            "maneuver_success_rate" => %{"burn_cleanup" => 0.5}
          }),
    ...
    assert get_in(artifact, ["provenance", "operational_feedback"]) == %{
             ...
             "trust_boundary" => "strategy_branch_feedback",
             "input_keys" => ["command_success_rate", "maneuver_success_rate"],
