defmodule OrbitalDynamics.CandidateRefresh.OperationalTimelineFeedbackBuildTest do
  ...
  test "derives contact and throughput feedback from source operational timeline reports" do
    report =
      Timeline.operational_report(
        [
          %{
            id: :dl_operational_feedback,
            type: :downlink,
            scenario_id: :sat_1,
            spacecraft_id: :sat_1,
            ...
            provenance: %{trust_boundary: :timeline_ops_review}
          }
        ],
        source: "ops.timeline"
      )
  ...
  test "preserves dependency and exclusivity integrity evidence from source operational timeline reports" do
    report = %{
      "schema_contract" => "operational_timeline_report.v1",
      "source" => "ops.timeline",
      "rows" => [
        %{
          "activity_id" => "dl_primary",
          "timeline_id" => "timeline:dl_primary",
          "type" => "downlink",
          "scenario_id" => "sat_1",
          "spacecraft_id" => "sat_1",
          "ground_station_id" => "equator_prime",
          ...
          "trust_boundary" => "timeline_ops_review"
        },
        %{
          "activity_id" => "dl_overlap",
          "timeline_id" => "timeline:dl_overlap",
          "type" => "downlink",
          "scenario_id" => "sat_1",
          "spacecraft_id" => "sat_1",
          "ground_station_id" => "equator_prime",
          "starts_at_s" => 20.0,
          "ends_at_s" => 50.0,
          "exclusive_with_activity_ids" => ["dl_primary"],
          "exclusivity_group" => "equator_prime_downlink",
          "exclusivity_violation_activity_ids" => ["dl_primary"],
      ...
      "trust_boundary" => "ops_timeline_report"
    }
