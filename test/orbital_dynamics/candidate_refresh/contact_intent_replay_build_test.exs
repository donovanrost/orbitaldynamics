defmodule OrbitalDynamics.CandidateRefresh.ContactIntentReplayBuildTest do
  ...
  test "replays unavailable source contact intents into ground network state" do
    intent = %{
      "schema_contract" => "contact_intent.v1",
      "id" => "prior_contact_intent_block",
      "activity_id" => "prior_contact_intent_block",
    ...
    artifact =
      ...
      |> CandidateRefresh.build(
        candidate_refresh:
          refresh_request()
          |> Map.put("source_contact_intent", intent),
  ...
  test "replays source contact intents from result artifact wrappers" do
    intent = %{
      "schema_contract" => "contact_intent.v1",
      "id" => "prior_contact_intent_capacity",
      "activity_id" => "prior_contact_intent_capacity",
      "activity_type" => "downlink",
      "scenario_id" => "leo_1",
      "ground_station_id" => "equator_prime",
      "direction" => "downlink",
    ...
    nested_demand_intent = %{
      "schema_contract" => "contact_intent.v1",
      "id" => "prior_contact_intent_nested_capacity",
      "activity_id" => "prior_contact_intent_nested_capacity",
    ...
    wrapper = %{
      ...
      "contact_intents" => [intent, nested_demand_intent],
    ...
    assert %{
             "paths" => [
               "source_result_artifact.contact_intents[0]",
               "source_result_artifact.contact_intents[1]"
             ],
             ...
             "required_capacity_fraction_contact_ids_by_source" => %{
               "capacity_model" => ["prior_contact_intent_nested_capacity"],
               "contact_required_capacity_fraction" => ["prior_contact_intent_capacity"]
             },
             "capacity_pack_contact_ids_by_ground_station" => %{
               "dss_43" => ["prior_contact_intent_nested_capacity"],
               "equator_prime" => ["prior_contact_intent_capacity"]
             },
