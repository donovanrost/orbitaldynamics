defmodule OrbitalDynamics.CandidateRefresh.CommandWindowFeedbackBuildTest do
  ...
  test "derives command success feedback from source command window reports" do
    report =
      CommandWindow.report([
        %{
          id: :cmd_window_feedback,
          type: :command,
          scenario_id: :sat_1,
          spacecraft_id: :sat_1,
          ...
          provenance: %{trust_boundary: :ops_command_review}
        }
      ])
      |> Map.put("required_operator_action_counts", %{"stale_command_window_action" => 99})
    ...
    assert get_in(artifact, [
           ...
           ]) == %{"review_terminal_activity_exception" => 1.0}
