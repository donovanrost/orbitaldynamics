defmodule OrbitalDynamics.CandidateRefresh.StationCalendarSourceReplayBuildTest do
  ...
  test "replays source station calendar reports into ground network state" do
    report = %{
      "schema_contract" => "station_calendar_report.v1",
      "affected_contacts" => [
        %{
          "id" => "station_calendar:prior_downlink_station_block",
          "contact_id" => "prior_downlink_station_block",
          ...
          "station_calendar_entry_id" => "prior_station_outage",
  ...
  test "replays station calendar capacity-pack fractions as station capacity" do
    report = %{
      "schema_contract" => "station_calendar_report.v1",
      "affected_contacts" => [
        %{
          "id" => "station_calendar:prior_downlink_capacity_pack_zero",
          "contact_id" => "prior_downlink_capacity_pack_zero",
          "contact_type" => "downlink",
          "scenario_id" => "leo_1",
          "ground_station_id" => "equator_prime",
          "direction" => "downlink",
          ...
          "station_calendar_entry_id" => "prior_station_capacity_pack_zero",
          "trust_boundary" => "ground_partner_api"
        }
      ]
    }
  ...
  test "replays station calendar nested availability as station capacity" do
    report = %{
      "schema_contract" => "station_calendar_report.v1",
      "affected_contacts" => [
        %{
          "id" => "station_calendar:prior_downlink_nested_availability_zero",
          "contact_id" => "prior_downlink_nested_availability_zero",
          "contact_type" => "downlink",
          "scenario_id" => "leo_1",
          "ground_station_id" => "equator_prime",
          "direction" => "downlink",
          "starts_at_s" => 250.0,
          "ends_at_s" => 450.0,
          "capacity_model" => %{"availability" => 0.0},
          "station_calendar_entry_id" => "prior_station_nested_availability_zero",
          "trust_boundary" => "ground_partner_api"
        }
      ]
    }
    ...
    assert [
             %{
               ...
               "source_station_calendar_entry" => %{
                 "station_calendar_entry_id" => "prior_station_nested_availability_zero",
                 "source_station_calendar_review" => %{
                   "capacity_model" => %{"availability" => nested_availability},
                   "id" => "station_calendar:prior_downlink_nested_availability_zero"
                 }
               }
             }
    ...
    assert nested_availability == 0.0

    assert {:ok, %{"schema_contract" => "candidate_refresh.v1", "status" => "pass"}} =
             Schema.validate_artifact(artifact)
  end

  test "replays station calendar reports from result artifact wrappers" do
    report = %{
      "schema_contract" => "station_calendar_report.v1",
      "affected_contacts" => [
        %{
          "id" => "station_calendar:prior_downlink_capacity_zero",
          "contact_id" => "prior_downlink_capacity_zero",
          "contact_type" => "downlink",
          "scenario_id" => "leo_1",
          "ground_station_id" => "equator_prime",
          "direction" => "downlink",
          ...
          "station_calendar_entry_id" => "prior_station_capacity_zero"
        }
      ]
    }
    ...
    wrapper = %{
      ...
      "station_calendar_report" => report,
  ...
  test "replays station calendar reports from operator review packages and Cadence import manifests" do
    report = %{
      "schema_contract" => "station_calendar_report.v1",
      "affected_contacts" => [
        %{
          "id" => "station_calendar:prior_reserved_contact",
          "contact_id" => "prior_reserved_contact",
          "contact_type" => "downlink",
          "scenario_id" => "leo_1",
          "ground_station_id" => "equator_prime",
          "direction" => "downlink",
          ...
          "station_calendar_entry_id" => "prior_reserved_station",
  ...
  test "inherits result artifact trust boundaries for reviewed and imported station calendar rows" do
    report = %{
      "schema_contract" => "station_calendar_report.v1",
      "affected_contacts" => [
        %{
          "id" => "station_calendar:reviewed_capacity_zero",
          "contact_id" => "reviewed_capacity_zero",
          "contact_type" => "downlink",
          "scenario_id" => "leo_1",
          "ground_station_id" => "equator_prime",
          "direction" => "downlink",
          ...
          "station_availability" => "reduced_capacity",
          "capacity_fraction" => 0.0,
          "station_calendar_entry_id" => "reviewed_station_capacity_zero"
        }
      ]
    }
    ...
    for {source, expected_path} <- [
          {
            ...
            "source_result_artifact.operator_review_package.rows.source_station_calendar_review"
          },
          {
            %{
              "source_result_artifact" => %{
            ...
            "source_result_artifact.cadence_import_manifest.rows.source_station_calendar_review"
          }
        ] do
      artifact =
        result_set()
