  ...
  @reference_fixtures %{
    ...
    "fixture.artifact.capability_catalog.v1" => %{
      ...
      "expected" => %{
        ...
        "artifact_contract_list_count" => 120,
        ...
        "candidate_refresh_input_count" => 71,
        "candidate_refresh_source_report_input_count" => 54,
    ...
    "fixture.artifact.schema_migration_report.deprecated_campaign_plan" => %{
      ...
      "expected" => %{
        ...
        "contract_count" => 120,
        "current_contract_count" => 119,
        "deprecated_contract_count" => 1,
        "future_contract_count" => 0,
        "migration_row_count" => 120,
        "deprecation_warning_count" => 1,
        "row_derived_contract_count" => 120,
        "status_counts" => %{"current" => 119, "deprecated" => 1},
        "row_derived_status_counts" => %{"current" => 119, "deprecated" => 1},
    ...
    "fixture.artifact.schema_migration_report.future_campaign_plan" => %{
      ...
      "expected" => %{
        ...
        "status_counts" => %{"current" => 120, "future" => 1},
        "row_derived_status_counts" => %{"current" => 120, "future" => 1},
        "migration_action_counts" => %{
