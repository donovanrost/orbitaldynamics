  ...
  defp station_reservation_summary_row(%{} = row, %{} = summary) do
    ...
    summary_context =
      %{
        ...
        "affected_contact_reservation_count" => summary["affected_contact_reservation_count"],
        "provider_calendar_contention_group_count" =>
          summary["provider_calendar_contention_group_count"],
        ...
        "expired_reservation_count" => summary["expired_reservation_count"],
        "active_reservation_count" => summary["active_reservation_count"],
        "missing_reservation_expiration_count" => summary["missing_reservation_expiration_count"],
