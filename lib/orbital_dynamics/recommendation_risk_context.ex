defmodule OrbitalDynamics.RecommendationRiskContext do
  ...
  @contact_allocation_context_keys [
  ...
  def contact_allocation_context_keys, do: @contact_allocation_context_keys
  ...
  def contact_allocation_context(risks) when is_list(risks) do
    risks = Enum.map(risks, &stringify_keys/1)

    contact_allocation_risks =
      Enum.filter(risks, &contact_allocation_risk?/1)
  ...
  def contact_allocation_context(_risks), do: %{}
  ...
  def objective_tradeoff_context(_risks), do: %{}
