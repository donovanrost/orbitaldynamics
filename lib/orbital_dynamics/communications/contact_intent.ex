defmodule OrbitalDynamics.Communications.ContactIntent do
  ...
  alias OrbitalDynamics.Communications.ContactIntent.Summary
  ...
  def capabilities do
    %{
      ...
      station_capacity_fraction_paths: CapacityEvidence.station_fraction_paths(),
      station_capacity_percent_paths: CapacityEvidence.station_percent_paths(),
      station_capacity_value_paths: CapacityEvidence.station_value_path_metadata(),
      required_capacity_fraction_paths: CapacityEvidence.required_fraction_paths(),
      required_capacity_percent_paths: CapacityEvidence.required_percent_paths(),
      required_capacity_value_paths: CapacityEvidence.required_value_path_metadata(),
      required_capacity_fraction_source_values: CapacityEvidence.required_source_values(),
      source_station_capacity_fraction_paths: CapacityEvidence.station_fraction_paths(),
      source_station_capacity_percent_paths: CapacityEvidence.station_percent_paths(),
      source_station_capacity_value_paths: CapacityEvidence.station_value_path_metadata(),
  ...
  def summary(contact_intents) when is_list(contact_intents) do
    ...
    |> Summary.build(%{
      ...
      summary_schema_contract: @summary_schema_contract,
      model_limits: model_limits(),
      normalize_direction: &normalize_contact_direction/1
    })
  end
  ...
  defp from_activity!(activity, timeline_row) do
    ...
    capacity_context = CapacityEvidence.station_context(activity)
    required_capacity_context = CapacityEvidence.required_context(activity)
