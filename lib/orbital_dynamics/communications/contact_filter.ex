defmodule OrbitalDynamics.Communications.ContactFilter do
  ...
  defp normalize_contact_direction(%{"type" => type} = contact)
       when type in @suppressed_directions,
       do: Map.put(contact, "direction", type)
  ...
  defp contact_id_issue(candidate) do
    raw_id =
  ...
  defp contact_identity_issue(candidate) do
