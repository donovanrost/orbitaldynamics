defmodule OrbitalDynamics.Communications.ContactAllocation do
  ...
  defp normalize_station_calendar_id_lists(context) do
    OrbitalDynamics.Communications.ContactAllocation.ContactIdentity.normalize_station_calendar_id_lists(
      context
    )
  end

  defp normalize_station_calendar_number_lists(context) do
    OrbitalDynamics.Communications.ContactAllocation.ContactIdentity.normalize_station_calendar_number_lists(
      context,
      &numeric_or_nil/1
    )
  end
  ...
  defp contact_station_calendar_entry_id(contact) do
    OrbitalDynamics.Communications.ContactAllocation.ContactIdentity.contact_station_calendar_entry_id(
      contact
    )
  end

  defp contact_station_calendar_provider_id(contact) do
    OrbitalDynamics.Communications.ContactAllocation.ContactIdentity.contact_station_calendar_provider_id(
      contact
    )
  end

  defp contact_station_calendar_provider_entry_id(contact) do
    OrbitalDynamics.Communications.ContactAllocation.ContactIdentity.contact_station_calendar_provider_entry_id(
      contact
    )
  end

  defp reservation_expires_at_s(contact) do
    OrbitalDynamics.Communications.ContactAllocation.ContactIdentity.reservation_expires_at_s(
      contact,
      &numeric_or_nil/1
    )
  end
  ...
  defp derive_station_calendar_counts(context) do
    OrbitalDynamics.Communications.ContactAllocation.ContactIdentity.derive_station_calendar_counts(
      context
    )
  end
