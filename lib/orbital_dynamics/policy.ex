defmodule OrbitalDynamics.Policy do
  ...
  defp requirement_context_value(requirement, field) do
    requirement
    |> requirement_context_maps()
    |> Enum.reduce_while(nil, fn context, _acc ->
      case context_value(context, field) do
        nil -> {:cont, nil}
        value -> {:halt, normalize_requirement_context_value(field, value)}
      end
    end)
  end

  defp requirement_context_values(requirement, "direction") do
    requirement
    |> requirement_context_maps()
  ...
  defp requirement_context_values(requirement, "ground_station_id") do
    requirement
    |> requirement_context_maps()
    |> Enum.flat_map(fn context ->
  ...
  defp requirement_context_values(requirement, "spacecraft_id") do
    requirement
    |> requirement_context_maps()
    |> Enum.flat_map(fn context ->
  ...
  defp requirement_context_values(requirement, "target_id") do
    requirement
    |> requirement_context_maps()
    |> Enum.flat_map(fn context ->
  ...
  defp requirement_context_values(requirement, field)
    ...
    |> Enum.map(&normalize_station_status_value/1)
    |> Enum.reject(&(&1 in [nil, ""]))
    |> Enum.uniq()
  end

  defp requirement_context_values(requirement, "resource_pressure_types") do
    requirement
    |> requirement_context_maps()
    |> Enum.flat_map(fn context ->
  ...
  defp requirement_context_values(requirement, "priority_fields_without_numeric_evidence") do
    requirement
    |> requirement_context_maps()
    |> Enum.flat_map(fn context ->
  ...
  defp requirement_context_values(requirement, "timeline_integrity_issue_types") do
    requirement
    |> requirement_context_maps()
    |> Enum.flat_map(fn context ->
  ...
  defp requirement_context_values(requirement, "source_timeline_integrity_issue_types") do
    requirement
    |> requirement_context_maps()
    |> Enum.flat_map(fn context ->
  ...
  defp requirement_context_values(requirement, "replacement_timeline_integrity_issue_types") do
    requirement
    |> requirement_context_maps()
    |> Enum.flat_map(fn context ->
  ...
  defp requirement_context_values(requirement, "station_calendar_trust_boundary_status") do
    requirement
    |> requirement_context_maps()
    |> Enum.flat_map(fn context ->
  ...
  defp requirement_context_values(requirement, "station_calendar_status") do
    requirement
    |> requirement_context_maps()
    |> Enum.flat_map(fn context ->
  ...
  defp requirement_context_values(requirement, "station_calendar_direction") do
    requirement
    |> requirement_context_maps()
    |> Enum.flat_map(fn context ->
  ...
  defp requirement_context_values(requirement, "station_calendar_provider_id") do
    requirement
    |> requirement_context_maps()
    |> Enum.flat_map(fn context ->
  ...
  defp requirement_context_values(requirement, "station_calendar_provider_entry_id") do
    requirement
    |> requirement_context_maps()
    |> Enum.flat_map(fn context ->
  ...
  defp requirement_context_values(requirement, "station_calendar_entry_id") do
    requirement
    |> requirement_context_maps()
    |> Enum.flat_map(fn context ->
  ...
  defp requirement_context_values(requirement, "station_calendar_reservation_id") do
    requirement
    |> requirement_context_maps()
    |> Enum.flat_map(fn context ->
  ...
  defp requirement_context_values(requirement, "station_reservation_id") do
    requirement
    |> requirement_context_maps()
    |> Enum.flat_map(fn context ->
  ...
  defp requirement_context_values(requirement, "station_reserved_by") do
    requirement
    |> requirement_context_maps()
    |> Enum.flat_map(fn context ->
  ...
  defp requirement_context_values(requirement, "station_reservation_status") do
    requirement
    |> requirement_context_maps()
    |> Enum.flat_map(fn context ->
  ...
  defp requirement_context_values(requirement, "station_reservation_match_status") do
    requirement
    |> requirement_context_maps()
    |> Enum.flat_map(fn context ->
  ...
  defp requirement_context_values(requirement, "station_calendar_reserved_by") do
    requirement
    |> requirement_context_maps()
    |> Enum.flat_map(fn context ->
  ...
  defp requirement_context_values(requirement, "station_calendar_reservation_status") do
    requirement
    |> requirement_context_maps()
    |> Enum.flat_map(fn context ->
  ...
  defp requirement_context_values(requirement, "station_calendar_ambiguous_entry_id") do
    requirement
    |> requirement_context_maps()
    |> Enum.flat_map(fn context ->
  ...
  defp requirement_context_values(requirement, field) do
    case requirement_context_value(requirement, field) do
      nil -> []
  ...
  defp normalize_requirement_context_value(field, value)
       when field in [
              "station_availability",
              "station_contention_status",
              "station_reservation_status",
    ...
    normalize_station_status_value(value)
  end

  defp normalize_requirement_context_value(_field, value), do: value

  defp normalize_station_status_value(values) when is_list(values) do
    values
    |> Enum.map(&normalize_station_status_value/1)
    |> Enum.reject(&(&1 in [nil, ""]))
  end

  defp normalize_station_status_value(nil), do: nil

  defp normalize_station_status_value(value) when is_binary(value) do
    value
    |> String.trim()
    |> String.downcase()
  ...
  defp normalize_station_status_value(value) when is_atom(value) do
    value
    |> Atom.to_string()
    |> normalize_station_status_value()
  end

  defp normalize_station_status_value(value), do: value

  defp normalize_direction_field(map, field) do
    case Map.fetch(map, field) do
      {:ok, value} -> Map.put(map, field, normalize_direction_value(value))
      :error -> map
    end
  end

  defp normalize_direction_value(values) when is_list(values) do
    values
    |> Enum.map(&normalize_direction_value/1)
    |> Enum.reject(&(&1 in [nil, ""]))
  end

  defp normalize_direction_value(nil), do: nil

  defp normalize_direction_value(value) when is_atom(value) do
    value
    |> Atom.to_string()
    |> normalize_direction_value()
  end

  defp normalize_direction_value(value) when is_binary(value) do
    normalized =
      value
      |> String.trim()
      |> String.downcase()
  ...
  defp normalize_direction_value(value), do: value

  defp direction_values(nil), do: []
  defp direction_values(values) when is_list(values), do: values
  defp direction_values(value), do: [value]

  defp canonical_direction_values(value) do
    value
    |> direction_values()
    |> Enum.map(&normalize_direction_value/1)
  end

  defp provider_result_context_value(requirement, field) do
    case requirement_context_value(requirement, field) do
      nil ->
        nil
  ...
  defp normalize_provider_result_token(value) when is_binary(value) do
    value
    |> String.trim()
    |> String.downcase()
    |> String.replace(~r/[\s-]+/, "_")
  ...
  defp normalize_provider_result_token(value) when is_atom(value) do
    value
    |> Atom.to_string()
    |> normalize_provider_result_token()
  end

  defp normalize_provider_result_token(value) when is_number(value),
    do: normalize_provider_result_token(to_string(value))

  defp normalize_provider_result_token(_value), do: nil
