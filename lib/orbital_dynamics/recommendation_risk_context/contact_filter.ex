defmodule OrbitalDynamics.RecommendationRiskContext.ContactFilter do
  @moduledoc false
  ...
  def context(risks) when is_list(risks) do
    ...
    %{
      ...
      "contact_filter_pressure_contact_ids" => risk_context_values(filter_risks, "contact_id"),
      "contact_filter_pressure_scenario_ids" => risk_context_values(filter_risks, "scenario_id"),
      "contact_filter_pressure_spacecraft_ids" =>
        risk_context_values(filter_risks, "spacecraft_id"),
      "contact_filter_pressure_ground_station_ids" =>
        risk_context_values(filter_risks, "ground_station_id"),
      "contact_filter_pressure_source_activity_ids" =>
        risk_context_values(filter_risks, ["source_activity_id", "source_activity_ids"]),
      "contact_filter_pressure_source_window_ids" =>
        risk_context_values(filter_risks, "source_window_id"),
      "contact_filter_pressure_required_contact_values" =>
        risk_context_values(filter_risks, "required_contacts"),
      "contact_filter_pressure_planned_contact_values" =>
        risk_context_values(filter_risks, "planned_contacts"),
      "contact_filter_pressure_required_downlink_values_mb" =>
        risk_context_values(filter_risks, "required_downlink_mb"),
      "contact_filter_pressure_planned_downlink_values_mb" =>
        risk_context_values(filter_risks, "planned_downlink_mb"),
      "contact_filter_pressure_start_values_s" =>
        risk_context_values(filter_risks, "starts_at_s"),
      "contact_filter_pressure_end_values_s" => risk_context_values(filter_risks, "ends_at_s"),
      "contact_filter_pressure_suppressed_reasons" =>
        risk_context_values(filter_risks, "suppressed_reason"),
      "contact_filter_pressure_review_statuses" =>
        risk_context_values(filter_risks, "review_status"),
      "contact_filter_pressure_station_reservation_ids" =>
        risk_context_values(filter_risks, "station_reservation_id"),
      "contact_filter_pressure_station_reserved_by" =>
        risk_context_values(filter_risks, "station_reserved_by"),
      "contact_filter_pressure_station_reservation_statuses" =>
        risk_context_values(filter_risks, "station_reservation_status"),
      "contact_filter_pressure_station_reservation_match_statuses" =>
        risk_context_values(filter_risks, "station_reservation_match_status"),
      "contact_filter_pressure_station_calendar_entry_ids" =>
        risk_context_values(filter_risks, "station_calendar_entry_id"),
      "contact_filter_pressure_station_calendar_entry_statuses" =>
        risk_context_values(filter_risks, "station_calendar_entry_status"),
      "contact_filter_pressure_downlink_demand_sources" =>
        risk_context_values(filter_risks, ["downlink_demand_sources"]),
      "contact_filter_pressure_downlink_completion_sources" =>
        risk_context_values(filter_risks, ["downlink_completion_sources"]),
      "contact_filter_pressure_feedback_sources" =>
  ...
  defp filter_risk?(%{"feedback_scope" => "contact_filter"}), do: true
