defmodule OrbitalDynamics.CadenceImport do
  ...
  defp strategy_recommendation_manifest_row(row, rank) do
    ...
    %{
      ...
      "refresh_freshness_statuses" => row["refresh_freshness_statuses"],
      "refresh_freshness_state_quality_statuses" =>
        row["refresh_freshness_state_quality_statuses"],
      "refresh_freshness_accepted_snapshot_age_values_s" =>
        row["refresh_freshness_accepted_snapshot_age_values_s"],
      "refresh_freshness_horizon_start_offset_values_s" =>
        row["refresh_freshness_horizon_start_offset_values_s"],
      "refresh_freshness_max_snapshot_age_values_s" =>
        row["refresh_freshness_max_snapshot_age_values_s"],
      "refresh_freshness_max_horizon_start_offset_values_s" =>
        row["refresh_freshness_max_horizon_start_offset_values_s"],
      "refresh_freshness_stale_reason_ids" => row["refresh_freshness_stale_reason_ids"],
      "refresh_freshness_unknown_reason_ids" => row["refresh_freshness_unknown_reason_ids"],
      "refresh_freshness_required_operator_actions" =>
        row["refresh_freshness_required_operator_actions"],
      "refresh_freshness_feedback_sources" => row["refresh_freshness_feedback_sources"],
      "refresh_freshness_feedback_scopes" => row["refresh_freshness_feedback_scopes"],
      "refresh_freshness_feedback_keys" => row["refresh_freshness_feedback_keys"],
      "refresh_freshness_trust_boundaries" => row["refresh_freshness_trust_boundaries"],
  ...
  defp generic_review_manifest_row(row, rank) do
    ...
    |> Map.merge(
      row
      |> Map.take(generic_review_passthrough_fields())
  ...
  defp generic_review_passthrough_fields do
    [
      "activity_id",
      "activity_type",
      "contact_id",
