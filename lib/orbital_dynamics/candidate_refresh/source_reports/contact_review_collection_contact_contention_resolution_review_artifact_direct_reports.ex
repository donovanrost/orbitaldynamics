defmodule OrbitalDynamics.CandidateRefresh.SourceReports.ContactReviewCollectionContactContentionResolutionReviewArtifactDirectReports do
  @moduledoc false

  def reports(refresh, entries, builder, source_key, artifact_key) do
    [
