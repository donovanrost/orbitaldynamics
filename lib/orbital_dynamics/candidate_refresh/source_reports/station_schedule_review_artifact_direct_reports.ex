defmodule OrbitalDynamics.CandidateRefresh.SourceReports.StationScheduleReviewArtifactDirectReports do
  @moduledoc false
  ...
  def reports(refresh, builder, source_key, artifact_key) do
    ...
    |> Enum.flat_map(fn {path, artifact_or_artifacts} ->
      StationCalendar.build_entries(path, artifact_or_artifacts, builder)
    end)
  end
end
