defmodule OrbitalDynamics.CandidateRefresh.SourceReports.OperationalTimelineValues do
  @moduledoc false
  ...
  def report?(%{} = report) do
    ...
    is_list(rows) and schema_contract in [nil, "operational_timeline_report.v1"]
  end
