defmodule OrbitalDynamics.CandidateRefresh.SourceReports.TimelineActivityPreconditionReviewImportEncoding do
  @moduledoc false
  ...
  defp encode_value(value), do: EncodedValue.value(value)
end
