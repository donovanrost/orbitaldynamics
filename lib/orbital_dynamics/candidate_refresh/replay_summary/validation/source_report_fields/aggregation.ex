defmodule OrbitalDynamics.CandidateRefresh.ReplaySummary.Validation.SourceReportFields.Aggregation do
  ...
  def source_report_family_identity_field(source_reports, family, field) do
    if source_report_family_has_identity_counts?(source_reports, family) do
      source_report_family_field(source_reports, family, field)
    end
  end
  ...
  def source_report_family_merge_string_lists(source_reports, family, field) do
    source_reports
    |> source_report_family_reports(family)
