defmodule OrbitalDynamics.CandidateRefresh.ReplaySummary.TimelineActivityLifecycleState.Summary do
  @moduledoc false
  ...
  def summary(lifecycle_summary, summary_source, replay_scope) do
    ...
    %{
      ...
      "contract" => source_report_summary_contract(lifecycle_summary, nil),
      ...
      "branch_local_timeline_activity_lifecycle_state_pressure" =>
        Map.get(pressure_fields, "branch_local_timeline_activity_lifecycle_state_pressure"),
      "branch_local_activity_lifecycle_review_pressure" =>
        Map.get(pressure_fields, "branch_local_activity_lifecycle_review_pressure"),
      "branch_local_activity_lifecycle_action_pressure" =>
        Map.get(pressure_fields, "branch_local_activity_lifecycle_action_pressure"),
      "branch_local_activity_lifecycle_routing_pressure" =>
        Map.get(pressure_fields, "branch_local_activity_lifecycle_routing_pressure"),
      "assumptions" => %{
        "execution_boundary" => "artifact_only_no_refresh_replay_mutation",
        "replay_scope" => replay_scope,
        "operator_authority" => "not_granted_by_timeline_activity_lifecycle_state_replay_summary",
        "timeline_mutation" => "not_performed_by_summary",
        "activity_lifecycle_application" => "not_performed_by_summary",
        "candidate_selection" => "not_performed_by_summary",
        "import_approval" => "not_granted_by_timeline_activity_lifecycle_state_replay_summary",
