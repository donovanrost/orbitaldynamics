defmodule OrbitalDynamics.CandidateRefresh.ReplaySummary.OperationalTimeline.SourceReportFields.Flattened do
  @moduledoc false
  ...
  def fields(source_reports) do
    %{
      ...
      "source_report_operational_timeline_operational_kind_counts" =>
        source_report_family_merge_count_maps(source_reports, "operational_kind_counts"),
      ...
      "source_report_operational_timeline_activity_status_counts" =>
        source_report_family_merge_count_maps(source_reports, "activity_status_counts"),
      "source_report_operational_timeline_approval_status_counts" =>
        source_report_family_merge_count_maps(source_reports, "approval_status_counts"),
  ...
  defp source_report_family_reports(source_reports) do
    source_reports
    |> Map.take(["operational_timeline_report"])
    |> Map.values()
  end

  defp source_report_family_count(source_reports, field) do
    if Map.has_key?(source_reports, "operational_timeline_report") do
      source_reports
  ...
  defp source_report_family_has_identity_counts?(source_reports) do
    case Map.get(source_reports, "operational_timeline_report") do
      %{} = summary ->
