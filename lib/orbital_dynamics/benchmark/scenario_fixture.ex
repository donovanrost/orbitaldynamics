defmodule OrbitalDynamics.Benchmark.ScenarioFixture do
  ...
  def circular_leo(opts \\ []) do
    ...
    validate!(count, radius_km, duration_s, output_step_s, dry_mass_kg, id_prefix)
    ...
    for index <- 1..count do
      ...
      spacecraft = Spacecraft.new!(:"#{id_prefix}_sat_#{index}", dry_mass_kg)
  ...
  defp validate!(count, radius_km, duration_s, output_step_s, dry_mass_kg, id_prefix) do
    cond do
