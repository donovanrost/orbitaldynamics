  ...
  def indicators(%{"type" => "observation_success_feedback"} = event) do
    [
      %{
        ...
        "candidate_windows" => event["candidate_windows"],
        "allowed_scenario_ids" => event["allowed_scenario_ids"],
        "spacecraft_constraints" => event["spacecraft_constraints"],
        "coverage_objective_id" => event["coverage_objective_id"],
