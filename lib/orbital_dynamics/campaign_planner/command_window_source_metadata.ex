defmodule OrbitalDynamics.CampaignPlanner.CommandWindowSourceMetadata do
  @moduledoc false
  ...
  def prior_plan(prior_plan, callbacks) do
    ReviewSourceReports.command_window_source_metadata(
  ...
  defp source_metadata_callbacks(callbacks) do
    Keyword.get_lazy(callbacks, :source_metadata_callbacks, fn ->
      [
        ...
        feedback_trust_boundaries: &CommandWindowOperationalFeedback.feedback_trust_boundaries/1
      ]
    end)
  end
end
