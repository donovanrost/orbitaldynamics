defmodule OrbitalDynamics.CampaignPlanner.TimelineDiffContactIdentityEventPayload do
  @moduledoc false
  ...
  def build(row, source_path, callbacks) do
    %{
      ...
      "ground_station_match_status" =>
        TimelineDiffContactCommandIdentityFields.contact_identity_match_status(
          row,
          "ground_station",
          callbacks
        ),
      ...
      "contact_identity_mismatch_fields" =>
        TimelineDiffContactCommandIdentityFields.contact_identity_mismatch_fields(row, callbacks),
      ...
      "derivation_reasons" =>
        TimelineDiffContactCommandIdentityFields.contact_identity_reasons(row, callbacks),
