defmodule OrbitalDynamics.MissionPlan.Activity do
  ...
  def precondition_summary(%__MODULE__{} = activity) do
    PreconditionSummary.build(activity, @unit_interval_fields)
  end
  ...
  defp optional_execution_uncertainty!(value), do: ExecutionUncertaintyInput.optional!(value)
  defp delta_v!(value), do: ExecutionUncertaintyInput.delta_v!(value)
