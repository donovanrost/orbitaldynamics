defmodule OrbitalDynamics.Schema.OperationalQualityGateSchemaValidationSummaryJsonSchema do
  @moduledoc false
  ...
  def property("schema_contract", _opts) do
    %{"type" => "string", "const" => "operational_quality_gate_schema_validation_summary.v1"}
  end
  ...
  def property("model", _opts) do
    %{"type" => "string", "const" => "artifact_only_quality_gate_schema_validation_summary"}
  end
  ...
  def property("schema_validation_status_counts", _opts) do
  ...
  def property("schema_validation_import_blocked", _opts) do
    %{"type" => "boolean"}
  end
