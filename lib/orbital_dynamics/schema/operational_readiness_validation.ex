defmodule OrbitalDynamics.Schema.OperationalReadinessValidation do
  ...
  def validate_optional_operational_quality_gate_operator_training_summary(issues, _path, nil),
    do: issues

  def validate_optional_operational_quality_gate_operator_training_summary(
        issues,
        path,
        %{} = summary
      ),
      do: validate_operational_quality_gate_operator_training_summary(issues, path, summary)
  ...
  def validate_optional_operational_quality_gate_schema_validation_summary(issues, _path, nil),
    do: issues

  def validate_optional_operational_quality_gate_schema_validation_summary(
        issues,
        path,
        %{} = summary
      ),
      do: validate_operational_quality_gate_schema_validation_summary(issues, path, summary)
  ...
  def validate_optional_operational_quality_gate_import_readiness_summary(issues, _path, nil),
    do: issues

  def validate_optional_operational_quality_gate_import_readiness_summary(
        issues,
        path,
        %{} = summary
      ),
      do: validate_operational_quality_gate_import_readiness_summary(issues, path, summary)
