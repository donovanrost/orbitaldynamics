defmodule OrbitalDynamics.Schema.CadenceSourceReviewRowCallbacks do
  @moduledoc false

  def build(local) when is_list(local) do
    [
      expect_optional_one_of: fetch!(local, :expect_optional_one_of),
      expect_optional_type: fetch!(local, :expect_optional_type),
      ...
      expect_optional_probability: fetch!(local, :expect_optional_probability),
      validate_selected_timeline_integrity_fields:
        fetch!(local, :validate_selected_timeline_integrity_fields),
      validate_stable_ids: fetch!(local, :validate_stable_ids),
      expect_optional_number: fetch!(local, :expect_optional_number),
      validate_optional_stable_id_list: fetch!(local, :validate_optional_stable_id_list),
