defmodule OrbitalDynamics.Schema.CampaignArtifactValidation do
  ...
  defp repair_callbacks do
    [
      ...
      validate_optional_candidate_refresh_model_limits:
        &OrbitalDynamics.Schema.CandidateRefreshModelLimitContracts.validate/3,
      validate_optional_candidate_refresh_accepted_planning_state:
        &OrbitalDynamics.Schema.CandidateRefreshAcceptedPlanningStateContracts.validate/3,
      ...
      validate_optional_timeline_activity_states:
        &TimelineSourceValidation.validate_optional_timeline_activity_states/3,
      validate_optional_timeline_preservation_statuses:
        &TimelineSourceValidation.validate_optional_timeline_preservation_statuses/3,
      validate_optional_timeline_publication_summaries:
        &TimelineSourceValidation.validate_optional_timeline_publication_summaries/3,
      ...
      validate_optional_validation_records:
      ...
      validate_optional_source_contact_allocation_summaries:
        &ContactAllocationValidation.validate_optional_summaries/3,
      ...
      validate_optional_source_contact_allocation_station_pressure_summaries:
        &ContactAllocationValidation.validate_optional_station_pressure_summaries/3,
      ...
      validate_optional_source_contact_allocation_reservation_conflict_summaries:
        &ContactAllocationValidation.validate_optional_reservation_conflict_summaries/3,
      ...
      validate_optional_source_contact_allocation_capacity_pack_summaries:
        &ContactAllocationValidation.validate_optional_capacity_pack_summaries/3,
      ...
      validate_optional_source_contact_allocation_provider_reservation_request_summaries:
        &ContactAllocationValidation.validate_optional_provider_reservation_request_summaries/3,
