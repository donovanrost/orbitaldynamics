defmodule OrbitalDynamics.Schema.ContactAllocationReservationConflictSummaryJsonSchema do
  ...
  def property_field?(field)
      when field in @row_fields or field in @count_fields or field in @count_map_fields or
  ...
  def property_opts("reservation_conflict_contact_ids_by_direction_and_ground_station_id", deps) do
  ...
  def assumptions(opts) do
    %{
      ...
      "properties" => %{
        ...
        "reservation_conflict_match_statuses" =>
          enum_array_const(Keyword.fetch!(opts, :reservation_conflict_match_statuses)),
        "station_reservation_expiration_statuses" =>
  ...
  defp assumptions_opts(deps) do
    [
      ...
      reservation_conflict_match_statuses: fetch_dep!(deps, :reservation_conflict_match_statuses),
      station_reservation_expiration_statuses:
