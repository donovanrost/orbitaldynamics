defmodule OrbitalDynamics.Schema.StrategyHandoffContracts do
  ...
  @timeline_lifecycle_state_context_field_pairs [
    {"timeline_lifecycle_state_statuses", "timeline_lifecycle_state_statuses"},
    {"timeline_lifecycle_state_planned_activity_count_values",
     "timeline_lifecycle_state_planned_activity_count_values"},
    {"timeline_lifecycle_state_realized_activity_count_values",
     "timeline_lifecycle_state_realized_activity_count_values"},
    {"timeline_lifecycle_state_row_count_values", "timeline_lifecycle_state_row_count_values"},
    ...
    {"timeline_lifecycle_state_requires_operator_review_values",
     "timeline_lifecycle_state_requires_operator_review_values"},
    {"timeline_lifecycle_state_feedback_sources", "timeline_lifecycle_state_feedback_sources"},
    {"timeline_lifecycle_state_feedback_scopes", "timeline_lifecycle_state_feedback_scopes"},
    {"timeline_lifecycle_state_feedback_keys", "timeline_lifecycle_state_feedback_keys"},
    {"timeline_lifecycle_state_trust_boundaries", "timeline_lifecycle_state_trust_boundaries"},
  ...
  @timeline_preservation_context_field_pairs OrbitalDynamics.RecommendationRiskContext.TimelinePreservation.field_pairs()
                                             |> Enum.reject(fn {field, _source_fields} ->
  ...
  @timeline_activity_precondition_context_field_pairs OrbitalDynamics.RecommendationRiskContext.TimelineActivityPrecondition.field_pairs()
                                                      |> Enum.reject(fn {field, _source_fields} ->
