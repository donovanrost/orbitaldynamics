...
Contact-intent recommendation rows likewise preserve their canonical candidate contact, source-activity, and ground-station IDs plus required and planned contact demand from source risks through operator review, direct selected Cadence import, and review-derived Cadence import. Executable validation rejects missing or stale derived identity or demand while legacy source/derived pairs may omit the optional context together.
