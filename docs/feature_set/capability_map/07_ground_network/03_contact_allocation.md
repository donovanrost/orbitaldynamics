...
Contact-contention-resolution recommendation rows separately preserve canonical risk type; contact, selected-contact, scenario, spacecraft, ground-station, source-activity, and source-window identity; required/planned contact and downlink demand; start/end bounds; selected priority source; selection reason/rule; override count/contact IDs; and review status across the same four copies. Executable validation rejects missing or stale derived resolution routing, demand, timing, or selection/review state while paired legacy omission remains compatible; selected-contact and override evidence record the source decision but do not execute it or mutate a schedule.
