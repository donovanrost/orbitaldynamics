...
Capacity-pack risk recommendation rows preserve canonical contact, source-activity, ground-station, and reduced-capacity pack-group identity across the same four copies. Executable validation rejects missing or stale derived capacity-pack risk routing while paired legacy omission remains compatible; the routing evidence remains descriptive and cannot reserve station time or mutate a schedule.
