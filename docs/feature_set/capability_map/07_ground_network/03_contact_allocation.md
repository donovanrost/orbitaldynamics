...
Contact-contention recommendation rows separately preserve canonical risk type plus contact, scenario, spacecraft, ground-station, source-activity, source-window, and contention-group identity across the same four copies. Executable validation rejects missing or stale derived contention routing while paired legacy omission remains compatible; contention-group identity remains descriptive and cannot reserve station time or mutate a schedule.
