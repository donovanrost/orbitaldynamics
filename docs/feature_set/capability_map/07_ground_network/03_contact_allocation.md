...
Contact-allocation recommendation rows preserve their canonical risk type; contact, scenario, spacecraft, ground-station, source-activity, source-window, and policy-bundle identity; required/planned contact and downlink demand; start/end bounds; and realized, contact-result, allocation, effective-allocation, review, approval, and policy-classification state with the allocation reason across the same four handoff copies. Executable validation rejects missing or stale derived routing, demand, timing, outcome/review, or policy context while legacy source/derived pairs may omit the optional context together. Policy context is descriptive and grants no execution authority.
