...
Contact-allocation recommendation rows preserve their canonical risk type and contact, scenario, spacecraft, ground-station, source-activity, and source-window identity across the same four handoff copies. Executable validation rejects missing or stale derived routing identity while alias-aware legacy source/derived pairs may omit the optional context together.
