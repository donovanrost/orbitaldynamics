...
Station-reservation-hold recommendation rows separately preserve canonical hold and contact identities plus expiration classification across the same four copies. Executable validation rejects missing or stale derived hold routing while paired legacy omission remains compatible; the evidence performs no provider or Cadence write and cannot accept a reservation or grant operator authority.
