...
Contact-intent recommendation rows likewise preserve their canonical candidate contact IDs from source risks through operator review, direct selected Cadence import, and review-derived Cadence import. Executable validation rejects missing or stale derived identity while legacy source/derived pairs may omit the optional context together.
