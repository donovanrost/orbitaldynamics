...
Contact-intent recommendation rows likewise preserve their canonical candidate contact, source-activity, ground-station, source-window, and timeline IDs plus timing bounds and required/planned contact-count and downlink-volume demand from source risks through operator review, direct selected Cadence import, and review-derived Cadence import. Executable validation rejects missing or stale derived identity, timing, or demand while legacy source/derived pairs may omit the optional context together.
