...
Capacity-pack risk recommendation rows preserve canonical contact, source-activity, ground-station, and reduced-capacity pack-group identity plus capacity-pack status and bounded capacity, used, unused, and required fractions across the same four copies. Executable validation rejects missing or stale derived capacity-pack risk routing or quantitative state while paired legacy omission remains compatible; the evidence remains descriptive and cannot reserve station time or mutate a schedule.
