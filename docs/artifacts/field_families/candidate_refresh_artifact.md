...
status, count, type, dependency, exclusivity, overlap, invalid-input, and
activity/timeline routing maps as `source_report_timeline_activity_precondition_*`
top-level rollups for compact consumers that do not inspect the nested
