...
Current slice:
CandidateRefresh contact-contention-resolution source-report identity contract.

Status:
Implemented, verified, and reviewed; pending publish.
Contact-contention-resolution source-report identity already uses the shared
...
status/selection/contact/station/direction/action maps still drive branch-local
...
- `mix test test/orbital_dynamics/candidate_refresh_test.exs:5027 test/orbital_dynamics/candidate_refresh_test.exs:5069 test/orbital_dynamics/candidate_refresh_test.exs:5097 test/orbital_dynamics/candidate_refresh_test.exs:5139 test/orbital_dynamics/candidate_refresh_test.exs:5171`
...
Last commit:
Previous published slice: `f776011338f3d736b552375551920947715ee521`.
